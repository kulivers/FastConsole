...
public class MyNestClient : IElasticClient
{
    public BulkAllObservable<T> BulkAll<T>(IEnumerable<T> documents, Func<BulkAllDescriptor<T>, IBulkAllRequest<T>> selector, CancellationToken cancellationToken = new CancellationToken()) where T : class
    {
    ...
    public IObservable<BulkAllResponse> Reindex<TSource, TTarget>(Func<TSource, TTarget> mapper, Func<ReindexDescriptor<TSource, TTarget>, IReindexRequest<TSource, TTarget>> selector, CancellationToken cancellationToken = new CancellationToken()) where TSource : class where TTarget : class
    {
        throw new NotImplementedException();
    }
    ...
    public IObservable<BulkAllResponse> Reindex<TSource, TTarget>(IReindexRequest<TSource, TTarget> request, CancellationToken cancellationToken = new CancellationToken()) where TSource : class where TTarget : class
    {
        throw new NotImplementedException();
    }
    ...
    public IObservable<BulkAllResponse> Reindex<TSource>(IndexName fromIndex, IndexName toIndex, Func<QueryContainerDescriptor<TSource>, QueryContainer> selector = null, CancellationToken cancellationToken = new CancellationToken()) where TSource : class
    {
        throw new NotImplementedException();
    }

    public IObservable<ScrollAllResponse<T>> ScrollAll<T>(Time scrollTime, int numberOfSlices, Func<ScrollAllDescriptor<T>, IScrollAllRequest> selector = null, CancellationToken cancellationToken = new CancellationToken()) where T : class
    {
        throw new NotImplementedException();
    }
    ...
    public Task<ListTasksResponse> DeleteByQueryRethrottleAsync(IDeleteByQueryRethrottleRequest request, CancellationToken ct = new CancellationToken())
    {
        throw new NotImplementedException();
    }
    ...
    public Task<ExistsResponse> DocumentExistsAsync<TDocument>(DocumentPath<TDocument> id, Func<DocumentExistsDescriptor<TDocument>, IDocumentExistsRequest> selector = null, CancellationToken ct = new CancellationToken()) where TDocument : class
    {
        throw new NotImplementedException();
    }
    ...
    public Task<ExistsResponse> SourceExistsAsync<TDocument>(DocumentPath<TDocument> id, Func<SourceExistsDescriptor<TDocument>, ISourceExistsRequest> selector = null, CancellationToken ct = new CancellationToken()) where TDocument : class
    {
        throw new NotImplementedException();
    }
    ...
    public Task<MultiSearchResponse> MultiSearchTemplateAsync(Indices index = null, Func<MultiSearchTemplateDescriptor, IMultiSearchTemplateRequest> selector = null, CancellationToken ct = new CancellationToken())
    {
        throw new NotImplementedException();
    }
    ...
    public Task<OpenPointInTimeResponse> OpenPointInTimeAsync(Indices index, Func<OpenPointInTimeDescriptor, IOpenPointInTimeRequest> selector = null, CancellationToken ct = new CancellationToken())
    {
        throw new NotImplementedException();
    }
    ...
    public Task<ExecutePainlessScriptResponse<TResult>> ExecutePainlessScriptAsync<TResult>(IExecutePainlessScriptRequest request, CancellationToken ct = new CancellationToken())
    {
        throw new NotImplementedException();
    }
    ...
    public Task<ISearchResponse<TDocument>> ScrollAsync<TInferDocument, TDocument>(Time scroll, string scrollId, Func<ScrollDescriptor<TInferDocument>, IScrollRequest> selector = null, CancellationToken ct = new CancellationToken()) where TInferDocument : class where TDocument : class
    {
        throw new NotImplementedException();
    }
    ...
    public Task<ISearchResponse<TDocument>> ScrollAsync<TDocument>(Time scroll, string scrollId, Func<ScrollDescriptor<TDocument>, IScrollRequest> selector = null, CancellationToken ct = new CancellationToken()) where TDocument : class
    {
        throw new NotImplementedException();
    }
    ...
    public Task<UpdateResponse<TDocument>> UpdateAsync<TDocument, TPartialDocument>(DocumentPath<TDocument> id, Func<UpdateDescriptor<TDocument, TPartialDocument>, IUpdateRequest<TDocument, TPartialDocument>> selector, CancellationToken ct = new CancellationToken()) where TDocument : class where TPartialDocument : class
    {
        throw new NotImplementedException();
    }
    ...
    public Task<ListTasksResponse> UpdateByQueryRethrottleAsync(IUpdateByQueryRethrottleRequest request, CancellationToken ct = new CancellationToken())
    {
        throw new NotImplementedException();
    }
